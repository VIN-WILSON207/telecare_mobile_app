...
class AppTheme {
  ...
  static const Color accentAlt = Color(0xFF4CAF7D); // Light Green Accent
  static const Color infoColor = Color(0xFF4CAF7D); // Green Info
  ...
  // Shared semantic colors for consistent status messaging.
  static const Color alertColor = warningColor;
  static const Color successSurface = Color(0xFFD1FAE5);
  static const Color alertSurface = Color(0xFFFEF3C7);
  static const Color errorSurface = Color(0xFFFEE2E2);
  static const Color protectedColor = Color(0xFF0F766E);
  ...
  static ThemeData get lightTheme {
    ...
    return base.copyWith(
      ...
      snackBarTheme: SnackBarThemeData(
        ...
        contentTextStyle: GoogleFonts.poppins(fontSize: 16),
      ),
