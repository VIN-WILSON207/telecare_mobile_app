    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoRow(Icons.person_outline_rounded, tr('full_name', lang), 'Dr. ${widget.user.fullName}'),
          _buildInfoRow(
          ...
          const SizedBox(height: 12),
          _buildClickableRow(Icons.schedule_rounded, tr('manage_availability', lang), () {
